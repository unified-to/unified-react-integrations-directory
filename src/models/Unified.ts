...
export const Plans: IPlan[] = [
    ...
    { name: 'Startup', description: 'Launch 100s of integrations in your production application.', min_price: 100, custom_oauth: true, price_per_mille_requests: 0.5, max_requests: 200000, stripe_product_id: 'prod_NpKIL9HEvIfdx2', stripe_plan_id: 'price_1N3fdgCym65m1EMKSjioHzB4', test_stripe_product_id: 'prod_Np1xniikGxq80G', test_stripe_plan_id: 'price_1N3NttCym65m1EMKareqBWRx', stripe_annual_price_id: 'price_1NiRJcCym65m1EMKBQRlxUZn', min_annual_price: 1000, stripe_price_id: 'price_1NkJTxCym65m1EMKoqLQqzNy', test_stripe_price_id: 'price_1NkISrCym65m1EMKRV9bJsqI', test_stripe_annual_price_id: 'price_1NkFggCym65m1EMKQ88k8pZo', stripe_overage_price_id: 'price_1NkJVbCym65m1EMKExtQwpbU', test_stripe_overage_price_id: 'price_1NkH5QCym65m1EMKmx9QKFl4' },
    { name: 'Growth', description: 'Your application is growing partially due to our integrations.', min_price: 500, stripe_product_id: 'prod_NpKIvppVcyFEy6', stripe_plan_id: 'price_1N3fdqCym65m1EMKKjyqXdak', max_requests: 1250000, price_per_mille_requests: 0.4, custom_oauth: true, test_stripe_product_id: 'prod_OXNbPZfryQINTy', test_stripe_plan_id: 'price_1N3fGjCym65m1EMKHZoz5Id5', min_annual_price: 5000, stripe_annual_price_id: 'price_1NkEWJCym65m1EMKalcplitD', stripe_price_id: 'price_1NkJXtCym65m1EMKFb6zMvGj', test_stripe_price_id: 'price_1NkIq7Cym65m1EMKFAFYEAeT', test_stripe_annual_price_id: 'price_1NkIq8Cym65m1EMKv84PiotO', stripe_overage_price_id: 'price_1NkJYbCym65m1EMKIUQ5g96B', test_stripe_overage_price_id: 'price_1NkIq7Cym65m1EMKh3nXHWaS' },
