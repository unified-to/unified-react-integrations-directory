...
export const schemaConnection = {
	...
	categories: { type: [ String ], enum: [ 'passthrough', 'hris', 'ats', 'auth', 'crm', 'enrich', 'martech', 'ticketing', 'uc', 'accounting', 'storage', 'commerce', 'payment', 'genai', 'messaging', 'kms', 'task', 'scim', 'lms', 'repo', 'metadata', 'calendar', 'verification', 'ads', 'analytics', 'forms', 'shipping', 'assessment', 'signing', 'clubs', 'datastore' ], index: true }, // The Integration categories that this connection supports
