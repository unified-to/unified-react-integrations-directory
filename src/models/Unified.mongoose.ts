...
export const schemaIntegrationSupport = {
	...
	webhook_type: { type: String, enum: [ 'virtual', 'none', 'native' ] },
	webhook_events: { type: [ String ], enum: [ 'updated', 'created' ] },
...
export const schemaIssue = {
	...
	title: { type: String },
	status: { type: String, enum: [ 'ON_HOLD', 'NEW', 'IN_PROGRESS', 'VALIDATING', 'COMPLETE', 'REJECTED' ] },
	url: { type: String },
	workspace_id: { type: SchemaTypes.ObjectId, index: true, ref: 'Workspace' },
...
export const schemaNotification = {
	...
	icon: { type: String }, // The icon name
	link_url: { type: String }, // Link to the event
...
export const schemaWebhook = {
	...
	object_type: { type: String, enum: [ 'accounting_account', 'accounting_transaction', 'accounting_contact', 'accounting_invoice', 'accounting_payment', 'accounting_taxrate', 'accounting_organization', 'accounting_payout', 'accounting_refund', 'commerce_item', 'commerce_collection', 'commerce_inventory', 'commerce_location', 'ats_application', 'ats_applicationstatus', 'ats_candidate', 'ats_document', 'ats_interview', 'ats_job', 'ats_scorecard', 'ats_company', 'crm_company', 'crm_contact', 'crm_deal', 'crm_event', 'crm_lead', 'crm_pipeline', 'hris_employee', 'hris_group', 'martech_list', 'martech_member', 'passthrough', 'ticketing_note', 'ticketing_ticket', 'ticketing_customer', 'uc_contact', 'uc_call', 'enrich_person', 'enrich_company', 'storage_file' ] }, // The object to return (eg. CRM "contact")
	...
	environment: { type: String, default: 'Production' },
	event: { type: String, enum: [ 'updated', 'created' ] },
...
export const schemaWorkspaceIntegration = {
	...
	categories: { type: [ String ], enum: [ 'passthrough', 'hris', 'ats', 'auth', 'crm', 'enrich', 'martech', 'ticketing', 'uc', 'accounting', 'storage', 'commerce' ] },
};
